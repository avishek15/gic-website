...
export const metadata: Metadata = {
    ...
    description:
        "Contact GIC for your e-governance and IT modernization needs. Expert team ready to deliver secure, scalable solutions. Serving clients across multiple time zones worldwide.",
    alternates: {
        canonical: "/contact",
    },
    openGraph: {
